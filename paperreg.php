...
<div id="container">
    <div class="row">
            <div class="col-md-6">
                <a href="index.html"><img src="img/techpost.jpg"height="100%" width="80%"></a> 
            ...
            <div class="col-md-6">
                ...
                <center><h1>REGISTER -- PAPER PRESENTATION</H1></center>
                </BR>
                </BR>
...
if(isset($_POST) and $_SERVER['REQUEST_METHOD'] == "POST")
    {
        ...
        $event="paperpresentaion";
       

        $sql = "insert into paperpresentation  values(?,?,?,?,?,?)";
        ...
        $check = mysqli_stmt_affected_rows($stmt);
         if($check){
                ...
                window.location.href='paperreg.php';
                </SCRIPT>");
            }
